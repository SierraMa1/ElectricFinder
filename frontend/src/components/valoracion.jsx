...
const Valoracion = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = () => {
    ...
    const apiSaveUser = '/api/valoraciones';
  ...
  return (
    <div className={`fixed z-10 inset-0 overflow-y-auto ${isOpen ? 'block' : 'hidden'}`}>
      <div className="flex items-center justify-center min-h-screen p-4 ">
        ...
        <div className=" rounded-lg overflow-hidden shadow-xl relative max-w-md w-full p-4 bg-gradient-to-r from-sky-100 to-slate-300 hover:to-neutral-200">
          <div className="flex justify-between items-center mb-4 ">
            <h3 className="text-lg font-bold font-switzer ">Valorar electricista</h3>
          ...
          <div className="mb-4">
            <label className="block text-md font-medium font-switzer font-semibold text-gray-900">Seleccionar electricista:</label>
            <select
          ...
          <div className="mb-4">
            <label className="block text-md font-medium font-switzer font-semibold text-gray-900">Puntuación:</label>
            <select
              value={puntuacion}
          ...
          <div className="mb-4">
            <label className="block text-md font-medium  font-switzer font-semibold text-gray-900">Comentario:</label>
            <textarea
              rows="3"
              value={comentario}
          ...
          <div className="flex justify-end">
            <button
              ...
              className={`inline-flex justify-center px-4 py-2 text-sm font-medium ${
                !electricistaSeleccionado || puntuacion === 0 ? ' bg-blue-500 hover:bg-blue-700 text-white font-bold cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 text-white'
