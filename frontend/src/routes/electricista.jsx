       ...
       <div className="container mx-auto mt-8">
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="flex flex-col lg:flex-row">
              ...
              {electricista.url_foto && electricista.typeFoto ? (
                <img src={`${electricista.url_foto}`} alt={`${electricista.nombre} ${electricista.apellido}`} className="w-full h-auto lg:h-64 object-cover" />
              ) : (
